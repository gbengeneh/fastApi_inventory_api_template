"""add organization_id to cashier_stations

Revision ID: 47a486df0d59
Revises: 3e63f131a653
Create Date: 2025-10-30 21:57:42.999503
...
revision: str = '47a486df0d59'
down_revision: Union[str, Sequence[str], None] = '3e63f131a653'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('cashier_stations') as batch_op:
        batch_op.add_column(sa.Column('organization_id', sa.INTEGER(), nullable=False))
        batch_op.create_foreign_key('fk_cashier_stations_organization_id', 'organizations', ['organization_id'], ['id'])
